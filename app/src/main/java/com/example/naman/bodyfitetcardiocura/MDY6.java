...
public class MDY6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mdy6);

        Button y1= (Button) findViewById(R.id.by1);
        y1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY6.this,YPopD5.class);
        ...
        y2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY6.this,YPopD2.class);
                startActivity(intent);
            }
        });
        ...
        y3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY6.this,YPopD3.class);
                startActivity(intent);
            }
        });
        ...
        y4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY6.this,YPopD4.class);
                startActivity(intent);
            }
        });
        ...
        y5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY6.this,YPopD1.class);
                startActivity(intent);
            }
        });
        ...
        y6.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY6.this,YPopD6.class);
                startActivity(intent);
            }
        });
        ...
        y7.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY6.this,YPopD20.class);
                startActivity(intent);
            }
        });
        ...
        y8.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY6.this,YPopD8.class);
                startActivity(intent);
            }
        });
        ...
        y9.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY6.this,YPopD13.class);
                startActivity(intent);
            }
        });
        ...
        y10.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY6.this,YPopD10.class);
                startActivity(intent);
            }
        });
