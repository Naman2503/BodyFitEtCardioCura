...
public class MDY2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mdy2);

        Button y1= (Button) findViewById(R.id.by1);
        y1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY2.this,YPopD6.class);
        ...
        y2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY2.this,YPopD11.class);
                startActivity(intent);
            }
        });
        ...
        y3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY2.this,YPopD7.class);
                startActivity(intent);
            }
        });
        ...
        y4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY2.this,YPopD12.class);
                startActivity(intent);
            }
        });
        ...
        y5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY2.this,YPopD8.class);
                startActivity(intent);
            }
        });
        ...
        y6.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY2.this,YPopD13.class);
                startActivity(intent);
            }
        });
        ...
        y7.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY2.this,YPopD9.class);
                startActivity(intent);
            }
        });
        ...
        y8.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY2.this,YPopD14.class);
                startActivity(intent);
            }
        });
        ...
        y9.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY2.this,YPopD10.class);
                startActivity(intent);
            }
        });
        ...
        y10.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MDY2.this,YPopD15.class);
                startActivity(intent);
            }
        });
